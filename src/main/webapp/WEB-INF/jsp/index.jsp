...
<body>
	...
	<blockquote>
		<footer>
			...
			<div>
				If you need VPN, you can donate developer to (ETH: <mark style="cursor: pointer;">0x23b96A20Fae711ED6D286feAEED437a6831e3dD7</mark>), bring your mail address in TRANSACTION DATA. And I'll send you the <a href="/files/Shadowsocks.exe" target="_blank">Shadowsocks</a> connection after receiving the currency..<br>
			</div>
			<div>
